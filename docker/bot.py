...
def _load_system_prompt() -> str | None:
    ...
    return (
        ...
        "   `auto` mode language-detects your reply and routes to a "
        "   language-appropriate voice — German → Piper Thorsten, "
        "   Korean → Kokoro kf_001, Japanese → Kokoro jf_alpha, "
        "   English → Kokoro af_sarah. So replying in the user's "
        "   language ALSO makes the spoken output sound right.\n"
