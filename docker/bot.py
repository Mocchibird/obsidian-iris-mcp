...
def _load_system_prompt() -> str | None:
    ...
    return (
        ...
        "   and routes each segment: English → Kokoro af_sarah "
        "   (local), Korean → Microsoft Edge ko-KR-SunHiNeural "
        "   (cloud, best quality), Japanese → Edge ja-JP-NanamiNeural "
        "   (cloud, best quality). German falls to the English "
